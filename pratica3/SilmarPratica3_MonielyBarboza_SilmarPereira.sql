...
/* a */
SELECT F.NOME_FC, F.IDEOLOGIA, L.NOME, L.ESPECIE, L.NACAO
...
INSERT INTO LIDER
	VALUES(
		'435.876.562-71', 'Livia Caral', 'Comandante', /*seu cargo eh presidente o que nao esta nas opcoes*/ 
		'Gallifrey',
		'Homo Tempus'
	);

 SELECT L.CPI, L.NOME,  L.NACAO, L.ESPECIE, E.NOME_CIENTIFICO, E.PLANETA_ORIGEM, F.NOME_FC
...
/*c*/
SELECT OA.NOME, OA.CLASSIFICACAO, OE.NOME, OE.CLASSIFICACAO
    FROM ESTRELA OA, ESTRELA OE, ORBITA_ESTRELA O
    WHERE O.ORBITADA = OA.ID_CATALOGO AND O.ORBITANTE = OE.ID_CATALOGO ;   

/*d*/
INSERT INTO PLANETA (DESIGNACAO_ASTRONOMICA)
	VALUES ('Mercurio');
...
INSERT INTO ESPECIE 
	VALUES('Homo Sapiens', 'Terra', 'S');

INSERT INTO ESPECIE 
	VALUES('V-Rex', 'Venus', 'N');
    
INSERT INTO ESPECIE 
	VALUES('Agaricus arvensis', 'Mercurio', 'N');
...
INSERT INTO HABITACAO (PLANETA, COM_ESPECIE, COM_NOME, DT_INICIO)
	VALUES(
		'Terra', 'Homo Sapiens', 'Humano',
		TO_DATE('07/11/2010', 'dd/mm/yyyy')
    );

INSERT INTO HABITACAO (PLANETA, COM_ESPECIE, COM_NOME, DT_INICIO)
	VALUES(
		'Venus', 'V-Rex', 'Dinossauro',
		TO_DATE('07/11/2000', 'dd/mm/yyyy')
    );

INSERT INTO HABITACAO (PLANETA, COM_ESPECIE, COM_NOME, DT_INICIO)
	VALUES(
		'Mercurio', 'Agaricus arvensis', 'Cogumelo',
		TO_DATE('04/11/2010', 'dd/mm/yyyy')
    );

SELECT H.PLANETA ,COUNT(E.INTELIGENTE) 
	FROM HABITACAO H LEFT JOIN ESPECIE E 
...
/*e TODO adicionar mais inserções para testar melhor essa query*/   
SELECT H.PLANETA, H.COM_ESPECIE,  COUNT(*)  
	FROM HABITACAO H 
	GROUP BY H.COM_ESPECIE, H.PLANETA;


/*f*/
/*
SELECT E.ID_CATALOGO FROM ESTRELA E, ORBITA_PLANETA O 
WHERE E.ID_CATALOGO = O.ESTRELA
GROUP BY O.ESTRELA
HAVING COUNT(*) >= 1;  
*/
...
INSERT INTO PLANETA 
	VALUES ('ALF C', 27.09, 40.315, 'hidrogenio', 'Gigante gasoso');
		
INSERT INTO PLANETA 
	VALUES ('ALF D', 6.67, 15.215, 'Nitrogenio', 'Planeta rochoso');
		
INSERT INTO PLANETA 
	VALUES ('ALF E', 3.07, 5.5, 'Metano', 'Planeta rochoso');
	
INSERT INTO ORBITA_PLANETA 
	VALUES ('ALF C', 'ALF CMa B', 100.467, 159.7, 325.754);

INSERT INTO ORBITA_PLANETA 
	VALUES ('ALF D', 'ALF CMa B', 350.44, 371.2, 675.34);

INSERT INTO ORBITA_PLANETA 
	VALUES ('ALF E', 'ALF CMa B', 590.7, 621.772, 1191.4);
...
*/
/*
SELECT E.NOME, E.CLASSIFICACAO FROM
ESTRELA E WHERE E.ID_CATALOGO IN 
(SELECT E.ID_CATALOGO FROM ESTRELA E, ORBITA_PLANETA O 
WHERE E.ID_CATALOGO = O.ESTRELA
GROUP BY O.ESTRELA
HAVING COUNT(*) >= 1 );
